...
class Services_Solicitud
{
	...
	public function saveSolicitudSeguroTecnico($solicitud,$params){
		...
		try {
			...
			//Guarda el ID de las tablas asociadas
			$m_solicitud->poliza_valores_id = $m_poliza_valores->poliza_valores_id;
			$m_solicitud->poliza_detalle_id = $m_poliza_detalle->detalle_seguro_tecnico_id;
			$m_solicitud->poliza_poliza_id = $params['poliza_renovada_id'];
			$m_solicitud->save();
...
public function saveSolicitudJudiciales($solicitud,$params){
		...
		try {
			...
			//Guarda el ID de las tablas asociadas
			$m_solicitud->poliza_valores_id = $m_poliza_valores->poliza_valores_id;
			$m_solicitud->poliza_detalle_id = $m_poliza_detalle->detalle_judiciales_id;
			$m_solicitud->poliza_poliza_id = $params['poliza_renovada_id'];
			$m_solicitud->save();
 ...
 */	
	...
	public function saveSolicitudVida($solicitud,$params){
		...
		try {
			...
			//Guarda el ID de las tablas asociadas
			$m_solicitud->poliza_valores_id = $m_poliza_valores->poliza_valores_id;
			$m_solicitud->poliza_detalle_id = $m_poliza_detalle->detalle_vida_id;
			$m_solicitud->poliza_poliza_id = $params['poliza_renovada_id'];
			$m_solicitud->save();
...
*/
	...
	public function saveSolicitudIntegralComercio($solicitud,$params){
		...
		try {
			...
			//Guarda el ID de las tablas asociadas
			$m_solicitud->poliza_valores_id = $m_poliza_valores->poliza_valores_id;
			$m_solicitud->poliza_detalle_id = $m_poliza_detalle->detalle_integral_comercio_id;
			$m_solicitud->poliza_poliza_id = $params['poliza_renovada_id'];
			$m_solicitud->save();
