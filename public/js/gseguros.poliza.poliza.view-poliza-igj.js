$(document).ready(
		function() {
			...
			$('#fecha_vigencia_poliza_igj').datepicker(
					{
						dateFormat : 'yy-mm-dd',
			...
			$('#valores_seguro_igj_show').click(function() {
				$('#valores_seguro_igj').toggle();
			});
			...
			$('#observaciones_seguro_igj_show').click(function() {
				$('#observaciones_seguro_igj').toggle();
			});
			$('#detalle_riesgo_igj_show').click(function() {
				$('#detalle_riesgo_igj').toggle();
			});
...
function confirmarSolicitudIgj(id) {
...
function aprobarSolicitudIgj(id){
